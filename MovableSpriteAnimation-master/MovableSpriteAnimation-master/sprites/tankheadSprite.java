...
public class tankheadSprite implements MovableSprite, DisplayableSprite {
    ...
    public Image getImage() {
        return rotatedImages[(int)(currentAngle + offsetAngle)%360];
	...
	public void update(Universe universe, KeyboardInput keyboard, long actual_delta_time) {
        ...
        if ((keyboard.keyDown(38)) && this.velocity < this.MAX_VELOCITY) {
            this.velocity += FORWARD;
        }       // DOWN
        else if ((keyboard.keyDown(40)) && this.velocity > - this.MAX_VELOCITY) {
        	if (this.velocity > 0) {
        		this.velocity -= BRAKE;
        	} else {
