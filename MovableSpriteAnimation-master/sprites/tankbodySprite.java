...
public class tankbodySprite implements MovableSprite, DisplayableSprite {
    ...
    private String filename = "res/tankdown.png";
    private double velocity = 0;
	private double velocityX = 0;
	private double velocityY = 0;
	
	public tankbodySprite(double centerX, double centerY) {
	...
	public void update(Universe universe, KeyboardInput keyboard, long actual_delta_time) {
        ...
        if ((keyboard.keyDown(38) || keyboard.keyDown(87)) && this.velocity < this.MAX_VELOCITY) {
            this.velocity += FORWARD;
        }       // DOWN
        else if ((keyboard.keyDown(40) || keyboard.keyDown(83)) && this.velocity > - this.MAX_VELOCITY) {
        	if (this.velocity > 0) {
        		this.velocity -= BRAKE;
        	} else {
